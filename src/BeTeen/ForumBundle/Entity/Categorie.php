...
class Categorie
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="BeTeen\ForumBundle\Entity\SujetStandard", mappedBy="categorie", cascade={"remove"})
     */
    ...
    public function addSujetsStandard(\BeTeen\ForumBundle\Entity\SujetStandard $sujetsStandards)
    {
        ...
        if($this->parent != null)
        {
            $this->parent->addSujetsStandard($sujetsStandards);
        }
    ...
    public function getParentRecursive()
    {
        if($this->parent != null)
        {
            $returnArray = $this->parent->getParentRecursive();
            array_push($returnArray,$this->parent);
        }
        else
        {
            $returnArray = array();
