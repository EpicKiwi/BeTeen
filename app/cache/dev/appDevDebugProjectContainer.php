...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'beteen', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6a976be2605fa2ee9278410fa4af6ff21eb759b463a06f50dc727a916d4efc5a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6a976be2605fa2ee9278410fa4af6ff21eb759b463a06f50dc727a916d4efc5a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6a976be2605fa2ee9278410fa4af6ff21eb759b463a06f50dc727a916d4efc5a');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\src\\BeTeen\\ForumBundle\\Entity')), 'BeTeen\\ForumBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BeTeenForumBundle' => 'BeTeen\\ForumBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\src\\BeTeen\\ForumBundle/Resources/views', 'BeTeenForum');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/Resources/views');
        $instance->addPath('D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'D:\\Utilisateurs\\Saclier\\Projets\\Git\\BeTeen\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5447b5efdf28e')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev',
            'kernel.logs_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/logs',
            'kernel.bundles' => array(
                ...
                'BeTeenForumBundle' => 'BeTeen\\ForumBundle\\BeTeenForumBundle',
            ...
            'debug.container.dump' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/../web',
            'assetic.write_to' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Utilisateurs/Saclier/Projets/Git/BeTeen/app/cache/dev/doctrine/orm/Proxies',
